...
// 	protoc        v6.33.5
// source: embedding/proto/embedding.proto
...
func (x *EmbeddingRequest) Reset() {
	*x = EmbeddingRequest{}
	mi := &file_embedding_proto_embedding_proto_msgTypes[0]
...
func (*EmbeddingRequest) Descriptor() ([]byte, []int) {
	return file_embedding_proto_embedding_proto_rawDescGZIP(), []int{0}
}
...
func (x *EmbeddingResponse) Reset() {
	*x = EmbeddingResponse{}
	mi := &file_embedding_proto_embedding_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EmbeddingResponse) Descriptor() ([]byte, []int) {
	return file_embedding_proto_embedding_proto_rawDescGZIP(), []int{1}
}
...
var (
	...
	file_embedding_proto_embedding_proto_rawDescData []byte
)

func file_embedding_proto_embedding_proto_rawDescGZIP() []byte {
	file_embedding_proto_embedding_proto_rawDescOnce.Do(func() {
		file_embedding_proto_embedding_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_embedding_proto_embedding_proto_rawDesc), len(file_embedding_proto_embedding_proto_rawDesc)))
	})
...
func init() { file_embedding_proto_embedding_proto_init() }
func file_embedding_proto_embedding_proto_init() {
	if File_embedding_proto_embedding_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_embedding_proto_embedding_proto_goTypes,
		DependencyIndexes: file_embedding_proto_embedding_proto_depIdxs,
		MessageInfos:      file_embedding_proto_embedding_proto_msgTypes,
	}.Build()
	File_embedding_proto_embedding_proto = out.File
	file_embedding_proto_embedding_proto_goTypes = nil
	file_embedding_proto_embedding_proto_depIdxs = nil
}
