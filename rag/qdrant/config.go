...
const (
	...
	defaultPort                = 6334
	defaultCollectionName      = "llm_rag_documents"
	defaultSimilarityThreshold = float32(0.6)
	defaultTopK                = 3
)
...
func LoadConfigFromEnv() (Config, error) {
	...
	similarityThreshold, err := loadFloat32FromEnv("RAG_SIMILARITY_THRESHOLD", defaultSimilarityThreshold)
	if err != nil {
		return Config{}, err
	}

	topK, err := loadIntFromEnv("RAG_DEFAULT_TOP_K", defaultTopK)
	if err != nil {
		return Config{}, err
	}
